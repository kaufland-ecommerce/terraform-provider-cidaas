...
- `accent_color` (String) Not supported for client_type = "NON_INTERACTIVE" apps; must be left unset there.
...
- `primary_color` (String) Not supported for client_type = "NON_INTERACTIVE" apps; must be left unset there.
